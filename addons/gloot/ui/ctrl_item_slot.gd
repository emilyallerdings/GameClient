...
@export var invcontainerslot:bool = true
...
func _on_dragable_dropped(dragable: CtrlDragable, drop_position: Vector2) -> void:
	...
	if invcontainerslot && item_slot.item != null:
		return
...
func _on_drop_zone_mouse_entered() -> void:
	...
	#CtrlInventoryItemRect.override_preview_size(Vector2(64,64))	
...
func _refresh() -> void:
	...
	if _ctrl_inventory_item_rect:
		...
		#_ctrl_inventory_item_rect.custom_minimum_size = Vector2(64,64)
...
func _process(delta):
	if _ctrl_inventory_item_rect:
		_ctrl_inventory_item_rect.custom_minimum_size = Vector2(64,64)
		_ctrl_inventory_item_rect.size = Vector2(64,64)
